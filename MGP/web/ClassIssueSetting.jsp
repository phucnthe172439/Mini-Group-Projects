                            ...
                            <div class="container card shadow d-flex justify-content-center mt-5">
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    ...
                                    <div class="tab-pane fade third show active" id="pills-profile" role="tabpanel" aria-labelledby="pills-contact-tab">
                                        <div class="order">
                                            <div>
                                                <form action="classIssuseSetting">
                                                    <div class="form-row">
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    Do you want to delete class with name ${u.type}
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                    <button type="button" onclick="window.window.location.href = '${pageContext.request.contextPath}/classIssuseSetting?id=${u.id}&action=delete&classID=${requestScope.classID}'" class="btn btn-primary">Save changes</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="modal fade" id="assUpdate${u.id}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form action="${pageContext.request.contextPath}/classIssuseSetting" method="post">
                                                                        <input type="hidden" name="id" value="${u.id}">
                                                                        <input type="hidden" name="action" value="update">
                                                                        <input type="hidden" name="classID" value="${requestScope.classID}">
                                                                        <div class="form-group">
                                                                            <label for="recipient-code" class="col-form-label">Type</label>
                                                                            <input type="text" class="form-control" id="recipient-code" name="type" value="${u.type}" required="">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="recipient-name" class="col-form-label">Work Processes</label>
                                                                            <input type="text" class="form-control" id="recipient-name" name="workprocess" value="${u.workprocess}" required="">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <div>
                                            ...
                                            <div class="box-footer clearfix" style="margin-left: 44%">
                                                <ul class="pagination pagination-sm no-margin pull-left text-center">
                                                    <c:if test="${requestScope.pageNum > 1}">
                                                        ...
                                                        <li class="page-item"><a style="font-size: larger;" class="page-link" href="${pageContext.request.contextPath}/classIssuseSetting?pageNum=${requestScope.pageNum + 1}&classID=${requestScope.classID}">Next</a></li>
                                                        </c:if>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="modal fade" id="addClassSetting" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Add New Issue Setting</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <form action="${pageContext.request.contextPath}/classIssuseSetting" method="post">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="recipient-code" class="col-form-label">Type</label>
                                                            <input type="text" class="form-control" id="recipient-code" name="type" required="">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="recipient-name" class="col-form-label">Work Processes</label>
                                                            <input type="text" class="form-control" id="recipient-name" name="workprocess" required="">
                                                        </div>
                                                        <div class="form-group">
                                                            <div>
                                                                <label for="status-active" class="col-form-label form-check-label">Active</label>

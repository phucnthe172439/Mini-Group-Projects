                            ...
                            <div class="container card shadow d-flex justify-content-center mt-5">
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    ...
                                    <div class="tab-pane fade third show active" id="pills-profile" role="tabpanel" aria-labelledby="pills-contact-tab">
                                        <div class="order">
                                            <div>
                                                <form action="classStudent">
                                                    <div class="form-row">
                                                        <input type="hidden" name="classID" value="${requestScope.classID}">
                                                        <div class="form-group col-md-3">
                                                            <label for="inputEmail4">Search </label>
                                                            <input type="email" class="form-control" name="searchAss" id="inputEmail4" value="${requestScope.search}" placeholder="Search By FullName/Email ....">
                                                        </div>
                                                    </div>
                                                    <button type="submit" class="btn btn-primary">Search</button>
                                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addsetting"><span class="status process">Add Student To Class</span></button>
                                                </form>
                                            </div>
                                            <table class="table table-hover" style="margin: 0 auto; width: 90%;">
                                                ...
                                                <tbody>
                                                    <c:forEach items="${requestScope.studentList}" var="u">
                                                        <tr>
                                                            ...
                                                            <td style="width: 25%;text-align: center">
                                                                <a data-toggle="modal" data-target="#delete${u.getUser_id()}" href="#">
                                                    ...
                                                    <div class="modal fade" id="delete${u.getUser_id()}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    Do you want to remove ${u.getFullname()} from class?
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                    <button type="button" onclick="window.window.location.href = '${pageContext.request.contextPath}/classStudent?id=${u.getUser_id()}&action=delete&classID=${requestScope.classID}'" class="btn btn-primary">Save changes</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="box-footer clearfix" style="margin-left: 44%">
                                                <ul class="pagination pagination-sm no-margin pull-left text-center">
                                                    <c:if test="${requestScope.pageNum > 1}">
                                                        ...
                                                        <li class="page-item"><a style="font-size: larger;" class="page-link" href="${pageContext.request.contextPath}/classStudent?pageNum=${requestScope.pageNum + 1}&classID=${requestScope.classID}">Next</a></li>
                                                        </c:if>
                                                </ul>
                                            </div>
                                        </div>
                                                ...
                                                <div class="modal-body">
                                                    <form action="${pageContext.request.contextPath}/classStudent" method="post">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="recipient-code" class="col-form-label">List Student</label>
                                                            <c:forEach items="${requestScope.users}" var="item">
                                                                <br>
                                                                <input type="checkbox" id="recipient-code" name="student" value="${item.getUser_id()}"> ${item.getFullname()}
                                                            </c:forEach>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>

                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header" style="margin-bottom: 10px;margin-top:20px;">
                            <h3 class="box-title" style="font-size: 35px; font-weight: bold;"><span>Subject List</span></h3>
                        </div>

                        <div class="box-tools" style="display: flex; justify-content: flex-start; align-items: center; margin-bottom: 20px; margin-left: 70px;">
                            <!-- Search form -->
                            <form action="subjectList">
                                <div class="form-row">
                                    <div class="input-group col-5">
                                        <input name="search" type="search" class="form-control" placeholder="Search..." value="${requestScope.searchValue}">
                            ...
                            <div class="input-group-btn" style="margin-left: 56%">
                                <button type="submit" class="btn btn-default" style="background-color: yellowgreen; border-radius: 4px;">
                                    <a style="color: white" data-toggle="modal" data-target="#addNewSubject" href="#">
                                        <i class="fa fa-plus"></i>New Subjects
                                    </a>
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover" style="margin: 0 auto; width: 90%;">
                                ...
                                <c:forEach items="${requestScope.subjects}" var="u">
                                    <tr>
                                        ...
                                        <td style="width: 10%;text-align: center">
                                            ${u.isActive eq true ? '<span style="color: green;">Active</span>' : '<span style="color: red;">Deactive</span>'}
                                        </td>
                                        <td style="width: 25%;text-align: center">
                                            ...
                                            <a href="${pageContext.request.contextPath}/subjectDetail?subID=${u.id}">
                                                <span style="font-size: 18px;" class="status process">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    Do you want to subject with name ${u.name}
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                    <button type="button" onclick="window.window.location.href = '${pageContext.request.contextPath}/subjectList?id=${u.id}&action=delete'" class="btn btn-primary">Save changes</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="modal fade" id="exampleModal${u.id}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="${pageContext.request.contextPath}/subjectList" method="post">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="description" name="description" id="message-text">${u.description}</textarea>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="status-active" class="col-form-label form-check-label">Active</label>
                                                            <input type="radio" class="form-check-input" id="status-active" name="status" value="1" ${u.isActive eq true? 'checked' : ''} required="">
                                                            <label for="status-inactive" class="col-form-label form-check-label">Inactive</label>
                                                            <input type="radio" class="form-check-input" id="status-inactive" name="status" value="0" ${u.isActive eq false? 'checked' : ''} >
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        ...
                        <div class="box-footer clearfix" style="margin-left: 44%">
                            <ul class="pagination pagination-sm no-margin pull-left text-center">
                                <c:if test="${requestScope.pagenum > 1}">
                                    <li class="page-item"><a style="font-size: larger;" class="page-link" href="${pageContext.request.contextPath}/subjectList?pagenum=${requestScope.pagenum - 1}">Previous</a></li>
                                    </c:if>
                                    ...
                                    <li class="page-item"><a style="font-size: larger;" class="page-link" href="${pageContext.request.contextPath}/subjectList?pagenum=${i}">${i}</a></li>
                                    </c:forEach>
                                    <c:if test="${requestScope.pagenum < requestScope.totalPage}">
                                    <li class="page-item"><a style="font-size: larger;" class="page-link" href="${pageContext.request.contextPath}/subjectList?pagenum=${requestScope.pagenum + 1}">Next</a></li>
                                    </c:if>

                            </ul>
                        </div>
                    </div>
                    <div class="modal fade" id="addNewSubject" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    <form action="${pageContext.request.contextPath}/addNewSubject" method="post">
                                        <div class="form-group">
                                            <label for="recipient-code" class="col-form-label">Subject Code</label>
                                            <input type="text" class="form-control" id="recipient-code" name="code" required="">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="description" class="col-form-label">Subject Description</label>
                                            <textarea class="form-control" id="description" name="description" id="message-text" required=""></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="status-active" class="col-form-label form-check-label">Active</label>
                                            <input type="radio" class="form-check-input" id="status-active" name="status" value="1" required="">
                                        </div>
                                        <div class="form-group">
                                            <label for="status-inactive" class="col-form-label form-check-label">Inactive</label>
                                            <input type="radio" class="form-check-input" id="status-inactive" name="status" value="0">
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>

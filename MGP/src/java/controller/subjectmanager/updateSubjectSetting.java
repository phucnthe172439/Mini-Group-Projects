 ...
 * @
 */
public class updateSubjectSetting extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String level = request.getParameter("process");
            Boolean status = request.getParameter("status").equals("1");
            ClassSettingDAO classSettingDAO = new ClassSettingDAO();
            classSettingDAO.update(id, title, status, level,Integer.parseInt(subID));

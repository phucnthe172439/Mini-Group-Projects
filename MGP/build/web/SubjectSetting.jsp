                                                ...
                                                <form action="SubjectSetting">
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col-md-3">
                                                            ...
                                                            <input type="text" class="form-control" name="search" id="inputEmail4" value="${requestScope.search}" placeholder="Search By Type/Name ....">
                                                        </div>
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button type="button" onclick="window.window.location.href = '${pageContext.request.contextPath}/SubjectSetting?id=${u.id}&action=delete&subID=${requestScope.subID}'" class="btn btn-primary">Yes</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
